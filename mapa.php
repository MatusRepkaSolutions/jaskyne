...
<div class="map-page">
    ...
    <div class="map-lang-switches">
        <a href="map.php?lang=svk" class="map-lang-btn" data-lang-switch="svk">
            <img src="img/index/slovakia.jpg" alt="Slovak">
        </a>

        <a href="map.php?lang=hun" class="map-lang-btn" data-lang-switch="hun">
            <img src="img/index/hungary.png" alt="Hungarian">
        </a>

        <a href="map.php?lang=eng" class="map-lang-btn" data-lang-switch="eng">
            <img src="img/index/england.png" alt="English">
        </a>
    </div>

    <div class="map-title" data-txt="mapTitle">
    ...
    <div class="map-content">
        ...
        <div class="map-right">
            ...
            <span class="map-paragraph" data-txt="map3">
