...
<body data-translation-page="jasovska">

<div class="cave-page" style="background: url('img/cavebg/jasovska.png');">
    ...
    <h1 class="cave-title" data-txt="jasovskaPageTitle">Ochtinská aragonitová jaskyňa</h1>
    ...
    <div class="cave-tab-panel active" id="tab-text">
        <div class="cave-side-info">
            <div class="cave-info-item">
                ...
                <div class="cave-info-value" data-txt="jasovskaInfoLengthValue">300 m</div>
            </div>

            <div class="cave-info-item">
                <div class="cave-info-label" data-txt="InfoTempLabel">Teplota vzduchu</div>
                <div class="cave-info-value" data-txt="jasovskaInfoTempValue">7,2 – 7,8 °C</div>
            </div>

            <div class="cave-info-item">
                <div class="cave-info-label" data-txt="InfoDepthLabel">Hĺbka (vertikálne rozpätie)</div>
                <div class="cave-info-value" data-txt="jasovskaInfoDepthValue">30 m</div>
            </div>

            <div class="cave-info-item">
                <div class="cave-info-label" data-txt="jasovskaInfoOldestInscriptionLabel">Vek najstaršieho aragonitu</div>
                <div class="cave-info-value" data-txt="jasovskaInfoOldestInscriptionValue">121 000 – 138 000 rokov</div>
            </div>

            <div class="cave-info-item">
                <div class="cave-info-label" data-txt="jasovskaInfoBatSpeciesCountLabel">Počet sprístupnených aragonitových jaskýň na svete</div>
                <div class="cave-info-value" data-txt="jasovskaInfoBatSpeciesCountValue">16</div>
            </div>
        </div>
    ...
    <div 
        ...
        id="tab-gallery"
        data-gallery-path="img/gallery/jasovska"
