...
<head>
    ...
    <title>Dobšínska ľadová jaskyňa</title>
...
<body data-translation-page="dobsinska">

<div class="cave-page" style="background: url('img/cavebg/dobsinska.png');">
    ...
    <h1 class="cave-title" data-txt="dobsinskaPageTitle">Ochtinská aragonitová jaskyňa</h1>
    ...
    <div class="cave-tab-panel active" id="tab-text">
        <div class="cave-side-info">
            <div class="cave-info-item">
                ...
                <div class="cave-info-value" data-txt="dobsinskaInfoLengthValue">300 m</div>
            </div>

            <div class="cave-info-item">
                <div class="cave-info-label" data-txt="InfoTempLabel">Teplota vzduchu</div>
                <div class="cave-info-value" data-txt="dobsinskaInfoTempValue">7,2 – 7,8 °C</div>
            </div>

            <div class="cave-info-item">
                <div class="cave-info-label" data-txt="dobsinskaInfoIceVolumeLabel">Vek najstaršieho aragonitu</div>
                <div class="cave-info-value" data-txt="dobsinskaInfoIceVolumeValue">121 000 – 138 000 rokov</div>
            </div>

            <div class="cave-info-item">
                <div class="cave-info-label" data-txt="dobsinskaInfoMaxIceThicknessLabel">Počet sprístupnených aragonitových jaskýň na svete</div>
                <div class="cave-info-value" data-txt="dobsinskaInfoMaxIceThicknessValue">16</div>
            </div>

            <div class="cave-info-item">
                <div class="cave-info-label" data-txt="dobsinskaInfoFirstElectricLitCaveInEuropeLabel">Počet sprístupnených aragonitových jaskýň na svete</div>
                <div class="cave-info-value" data-txt="dobsinskaInfoFirstElectricLitCaveInEuropeValue">16</div>
            </div>
        </div>
    ...
    <div 
        ...
        id="tab-gallery"
        data-gallery-path="img/gallery/dobsinska"
