...
<body data-translation-page="gombasecka">

<div class="cave-page" style="background: url('img/cavebg/gombasecka.png');">
    ...
    <h1 class="cave-title" data-txt="gombaseckaPageTitle">Ochtinská aragonitová jaskyňa</h1>
    ...
    <div class="cave-tab-panel active" id="tab-text">
        <div class="cave-side-info">
            <div class="cave-info-item">
                ...
                <div class="cave-info-value" data-txt="gombaseckaInfoLengthValue">300 m</div>
            </div>

            <div class="cave-info-item">
                <div class="cave-info-label" data-txt="InfoTempLabel">Teplota vzduchu</div>
                <div class="cave-info-value" data-txt="gombaseckaInfoTempValue">7,2 – 7,8 °C</div>
            </div>

            <div class="cave-info-item">
                <div class="cave-info-label" data-txt="gombaseckaInfoSodaStrawLengthLabel">Hĺbka (vertikálne rozpätie)</div>
                <div class="cave-info-value" data-txt="gombaseckaInfoSodaStrawLengthValue">30 m</div>
            </div>

            <div class="cave-info-item">
                <div class="cave-info-label" data-txt="gombaseckaInfoOpenSinceLabel">Vek najstaršieho aragonitu</div>
                <div class="cave-info-value" data-txt="gombaseckaInfoOpenSinceValue">121 000 – 138 000 rokov</div>
            </div>

            <div class="cave-info-item">
                <div class="cave-info-label" data-txt="gombaseckaInfoDepthValue">Počet sprístupnených aragonitových jaskýň na svete</div>
                <div class="cave-info-value" data-txt="gombaseckaCap1">16</div>
            </div>
        </div>
    ...
    <div 
        ...
        id="tab-gallery"
        data-gallery-path="img/gallery/gombasecka"
