...
<body data-translation-page="silicka">

<div class="cave-page" style="background: url('img/cavebg/silicka.png');">
    ...
    <h1 class="cave-title" data-txt="silickaPageTitle">Ochtinská aragonitová jaskyňa</h1>
    ...
    <div class="cave-tab-panel active" id="tab-text">
        <div class="cave-side-info">
            <div class="cave-info-item">
                ...
                <div class="cave-info-value" data-txt="silickaInfoLengthValue">300 m</div>
            </div>

            <div class="cave-info-item">
                <div class="cave-info-label" data-txt="InfoDepthLabel">Teplota vzduchu</div>
                <div class="cave-info-value" data-txt="silickaInfoDepthValue">7,2 – 7,8 °C</div>
            </div>

            <div class="cave-info-item">
                <div class="cave-info-label" data-txt="silickaInfoLowestAltitudeIceCaveWorldLabel">Hĺbka (vertikálne rozpätie)</div>
                <div class="cave-info-value" data-txt="silickaInfoLowestAltitudeIceCaveWorldValue">30 m</div>
            </div>

            <div class="cave-info-item">
                <div class="cave-info-label" data-txt="InfoTempLabel">Vek najstaršieho aragonitu</div>
                <div class="cave-info-value" data-txt="silickaInfoTempValue">121 000 – 138 000 rokov</div>
            </div>

            <div class="cave-info-item">
                <div class="cave-info-label" data-txt="silickaInfoFormationByCollapseDomeCeilingLabel">Počet sprístupnených aragonitových jaskýň na svete</div>
                <div class="cave-info-value" data-txt="silickaInfoFormationByCollapseDomeCeilingValue">16</div>
            </div>
        </div>
    ...
    <div 
        ...
        id="tab-gallery"
        data-gallery-path="img/gallery/silicka"
