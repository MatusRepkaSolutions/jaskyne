...
<body data-translation-page="imrehovassa">

<div class="cave-page" style="background: url('img/cavebg/imrehovassa.png');">
    ...
    <h1 class="cave-title" data-txt="imrehovassaPageTitle">Ochtinská aragonitová jaskyňa</h1>
    ...
    <div class="cave-tab-panel active" id="tab-text">
        ...
        <div class="cave-main-2 custom-scroll" id="scroll-1">
            <div class="cave-text-content">
                <p data-txt="imrehovassaParagraph1">
                ...
                <p data-txt="imrehovassaParagraph2">
