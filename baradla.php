...
<body data-translation-page="baradla">

<div class="cave-page" style="background: url('img/cavebg/baradla.png');">
    ...
    <h1 class="cave-title" data-txt="baradlaPageTitle">Ochtinská aragonitová jaskyňa</h1>
    ...
    <div 
        ...
        id="tab-gallery"
        data-gallery-path="img/gallery/baradla"
