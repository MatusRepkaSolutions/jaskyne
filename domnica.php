...
<body data-translation-page="domnica">

<div class="cave-page" style="background: url('img/cavebg/domnica.png');">
    ...
    <h1 class="cave-title" data-txt="domnicaPageTitle">Ochtinská aragonitová jaskyňa</h1>
    ...
    <div class="cave-tab-panel active" id="tab-text">
        <div class="cave-side-info">
            <div class="cave-info-item">
                ...
                <div class="cave-info-value" data-txt="domnicaInfoLengthValue">300 m</div>
            </div>

            <div class="cave-info-item">
                <div class="cave-info-label" data-txt="InfoTempLabel">Teplota vzduchu</div>
                <div class="cave-info-value" data-txt="domnicaInfoTempValue">7,2 – 7,8 °C</div>
            </div>

            <div class="cave-info-item">
                <div class="cave-info-label" data-txt="domicaInfoBoatRideLengthLabel">Hĺbka (vertikálne rozpätie)</div>
                <div class="cave-info-value" data-txt="domicaInfoBoatRideLengthValue">30 m</div>
            </div>

            <div class="cave-info-item">
                <div class="cave-info-label" data-txt="domicaInfoPrehistoricSettlementLabel">Vek najstaršieho aragonitu</div>
                <div class="cave-info-value" data-txt="domicaInfoPrehistoricSettlementValue">121 000 – 138 000 rokov</div>
            </div>

            <div class="cave-info-item">
                <div class="cave-info-label" data-txt="domicaInfoBatSpeciesCountLabel">Počet sprístupnených aragonitových jaskýň na svete</div>
                <div class="cave-info-value" data-txt="domicaInfoBatSpeciesCountValue">16</div>
            </div>
        </div>

        <div class="cave-main custom-scroll" id="scroll-1">
            <div class="cave-text-content">
                <p data-txt="domnicaParagraph1">
    ...
    <div 
        ...
        id="tab-gallery"
        data-gallery-path="img/gallery/domnica"
